...
<Callout type="info" emoji="👉">
	<ul>
		<li>- If your NFT's metadata are immutable (non-editable), check out [this page](./metadata-tool).</li>
		<li>- Make sure that the dedicated secondary image of your NFT meets [the Ledger Stax’s image requirements](./image-requirements).</li>
	</ul>
</Callout>
...
2. Add 2 new properties:
	...
	- b. JSON attribute `ledger_stax_image` that points to the location (URL) of your Ledger Stax image: 
		...
		<Callout type="warning" emoji="⚠️">
  			Please make sure that the image meets the [Ledger Stax requirements](./image-requirements). 
		</Callout>
