...
<Callout type="info" emoji="👉">
    You can refer to existing implementations to complete given examples, such as the [Polkadot integration](https://github.com/LedgerHQ/ledger-live/tree/develop/libs/ledger-live-common/src/families/polkadot).
</Callout>
