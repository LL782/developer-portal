...
<Callout type="warning" emoji="⚠️">
  **Prerequisite** <br/>
  Your computer must be set up accordingly. Please follow the following guides:  
  - [ledger-live CLI](https://ledgerhq.atlassian.net/wiki/spaces/WALLETCO/pages/2610659678/Ledger+Live+Common#ledger-live-cli)
  - Physical Ledger device or an [emulated device with Speculos](../../device-app/tools/speculos)
</Callout>
