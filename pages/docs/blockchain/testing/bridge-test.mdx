...
<Callout type="warning" emoji="⚠️">
  **Prerequisites**   
    <ul>
        <li>Your computer must be set up accordingly. Please follow the following guides:  </li>
        <li>- [ledger-live CLI](https://ledgerhq.atlassian.net/wiki/spaces/WALLETCO/pages/2610659678/Ledger+Live+Common#ledger-live-cli)  </li>
        <li>- Physical Ledger device or an [emulated device with Speculos](../../device-app/tools/speculos)  </li>
    </ul>
</Callout> 
