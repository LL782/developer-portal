...
![Folder of the Application](/tutorial-2-folder.png)
...
function SmartContract({eth,address}) {
  ...
  const updateData = async e => {
    ...
    console.log(hash);
    setUrl("https://goerli.etherscan.io/tx/" + hash);
  };
...
![Application Running on Browser](/tutorial-2-connect.png)
...
![Connect the Ledger with Bluetooth](/tutorial-2-pairing.png)
...
![Get data from a smart contract](/tutorial-2-getdata.png)
...
![Change data from a smart contract](/tutorial-2-changedata.png)
...
<div className="center">
  <figure>
    <img src="/ledger-tx-review.jpg" alt="Nano Review Screen"/>
    <br/>
    <img src="/ledger-tx-amount.jpg" alt="Nano Amount Screen"/>
...
<div className="center">
  <figure>
    <img src="/ledger-tx-address.jpg" alt="Nano Address Screen"/>
    <br/>
    <img src="/ledger-tx-network.jpg" alt="Nano Network Screen"/>
...
<div className="center">
  <figure>
    <img src="/ledger-tx-fees.jpg" alt="Nano Max Fees Screen"/>
    <br/>
    <img src="/ledger-tx-accept.jpg" alt="Nano Accept and Send Screen"/>
...
![Ropsten Etherscan](/tutorial-2-etherscan1.png)    
*Fig. 15: Ropsten Etherscan*

Wait till the status passes to Success.

![Ropsten Etherscan](/tutorial-2-etherscan2.png)    
...
![Verify the data](/tutorial-2-getdata2.png)  
*Fig. 17: Verify the data*

![Verify the data](/tutorial-2-getdata3.png)   
