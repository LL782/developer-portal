...
<Callout type="warning" emoji="⚠️">
  Comment out or remove the `import` package you don't use <br/>
  (`@ledgerhq/hw-transport-webusb` or `@ledgerhq/hw-transport-webhid`) <br/>
  and the `const transport` you don't use.<br/><br/>
  In the example, we use webusb. Webhid is already commented on lines 8 and 23.
</Callout>
...
const initial = "<h2>Connect your your Ledger Device<br/><br/>and open the Ethereum app. <br/><br/>Click on “Hash my message”</h2>";
...
document.querySelector("#hashMessage").addEventListener("click", async () => {
 ...
 try {
   ...
   $main.innerHTML = "<h1>Your signed message is:</h1>";
   $main.appendChild(h2);
...
![Hash Message](/connectivity/hash-message.png)
...
<div className="center">
  <img src="/connectivity/sign-message-01.png" alt="Hash Message"/>
</div>
...
<br/>
<div className="center">
  <img src="/connectivity/sign-message-02.png" alt="Hash Message"/>
</div>
...
<br/>
<div className="center">
  <img src="/connectivity/sign-message-03.png" alt="Hash Message"/>
</div>
<br/>
<div className="center">
  <img src="/connectivity/sign-message-04.png" alt="Hash Message"/>
</div>
...
<Zoom>
  <img
    alt="Runkit"
    src="/connectivity/runkit-verification.png"
  />
</Zoom>
