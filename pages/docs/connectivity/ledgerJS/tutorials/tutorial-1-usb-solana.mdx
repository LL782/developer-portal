...
Before starting, make sure you go through the [Development Prerequisites](../../integration-walkthrough).
...
![Folder tutorial](/connectivity/folder-e2e-sol.png)
  ...
  <body className="m-5">
    <div className="d-flex flex-column justify-content-center m-5 align-items-center">
      ...
      <div className="d-flex flex-row w-100 justify-content-around">
        ...
        <button className="btn btn-primary w-25" id="get-information">Get Information</button>
      </div>
    </div>
    <div className="d-flex flex-row">
      <div id="app" className="w-50">
        <form className="row g-3">
          ...
          <div className="col-md-12">
            <label for="recipient" className="form-label" disabled>Balance</label>
          ...
          <div className="col-md-6">
            <label for="gasPrice" className="form-label">Gas Price in lamports</label>
      ...
      <div className="w-50 d-flex flex-column">
            <p className="url">Solana explorer:</p>
...
![Application running on browser](/connectivity/tutorial-1-solana.png)
...
<div className="center">
  <figure>
      <img src="/connectivity/ledgerCodePin.jpg" alt="Ledger Enter Code Pin"/>
...
<div className="center">
  <figure>
      <img src="/connectivity/ledgerSol.jpg" alt="Run Solana Application on Ledger Nano"/>
...
![Choice of Wallet](/connectivity/tutorial-1-solana-wallet.png)   
*Fig. 6: Choice of Wallet*

Now choose the Ledger Nano to connect it to the browser.

![Connect the Ledger Nano](/connectivity/tutorial-1-solana-pairing.png)
...
![Application After Connecting Ledger Nano](/connectivity/tutorial-1-solana-info.png)
...
![Solana Faucet](/connectivity/solana-faucet.png)
*Fig. 9: Solana Faucet*
...
![Application After Connecting Ledger Nano](/connectivity/tutorial-1-solana-create.png)
...
![Result after Sending Transaction](/connectivity/tutorial-1-solana-transaction.png)
*Fig. 11: Transaction Information URL*

If you go on Solana Explorer you can see the information of your transaction.

![Result after Sending Transaction](/connectivity/solana-explorer-1.png)
*Fig. 12: Result on Solana Explorer after Sending Transaction*

![Result after Sending Transaction](/connectivity/solana-explorer-2.png)
