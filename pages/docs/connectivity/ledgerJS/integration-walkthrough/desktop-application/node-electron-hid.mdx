...
![Folder of the Application](/folderNodeHID.png)
...
![Node Desktop Application](/electron-node-hid-window.png)  
...
<div className="center">
  <figure>
      <img src="/ledgerBtc.jpg" alt="Embedded Application"/>
...
![Address Account Displayed](/electron-node-address.png)  
*Fig. 6: Address Account Displayed*

Congratulations you have successfully built your first Node Electron HID application connected with your Ledger!
