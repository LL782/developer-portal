...
document.getElementById("main").innerHTML =
  "<h2>Connect your your Ledger Device<br/><br/>and open the Bitcoin app...</h2>";

ipcRenderer.on("bitcoinInfo", (event, arg) => {
  const h1 = document.createElement("h2");
  h1.textContent = arg.bitcoinAddress;
  document.getElementById("main").innerHTML =
    "<h1>Congratulations!</h1><br/><h1>You are connected to your Ledger Device</h1><br/><h2>Your first Bitcoin address is:</h2>";
