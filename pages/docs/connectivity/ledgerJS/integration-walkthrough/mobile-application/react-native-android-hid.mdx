...
<div className="center">
  <figure>
    <img src="/folder-rn-android.png" alt="Folder of the Application"/>
...
Congratulations you have successfully built your first Android HID application connected with your Ledger!
