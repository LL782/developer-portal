...
const initial = "<h2>Connect your your Ledger Device<br/><br/>and open the Bitcoin app. <br/><br/>Click anywhere to start</h2>";
...
document.body.addEventListener("click", async () => {
  ...
  try {
    ...
    $main.innerHTML = "<h1>Congratulations!</h1><br/><h1>You are connected to your Ledger Device</h1><br/><h2>Your first Bitcoin address is:</h2>";
    $main.appendChild(h2);
