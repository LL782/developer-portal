...
description: The DApp Connect Kit lets you connect your DApps to Ledger hardware wallets. Read this page to know how it works.
---
...
<Callout type="info" emoji="👉">
  <ul>
    ...
    <li>The [LedgerJS packages](./ledgerJS/) are not guaranteed to be maintained.</li>
  </ul>
</Callout>
...
This happens rarely, but it is independent of control of Fedger. In this case, please refer to the DApp owner.  
