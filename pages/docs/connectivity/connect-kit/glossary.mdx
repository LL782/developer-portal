...
| WalletConnect    | Another legacy [connection type](https://www.ledger.com/blog/walletconnect-now-available-on-desktop-with-ledger-live) on Ledger Live. It relies on the [WalletConnect Protocol](https://docs.walletconnect.com/2.0) |
