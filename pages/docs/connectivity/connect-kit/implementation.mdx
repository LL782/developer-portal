...
<Callout type="info" emoji="👉">
  If you want a working example application that you can try by yourself you can find it on the [Connect Kit GitHub repository](https://github.com/LedgerHQ/connect-kit/tree/main/examples/direct-integration)
</Callout>
...
<Callout type="info" emoji="👉">
  If you want a working example application that you can try by yourself you can find it on the [Connect Kit GitHub repository](https://github.com/LedgerHQ/connect-kit/tree/main/examples/next-wagmi)
</Callout>
