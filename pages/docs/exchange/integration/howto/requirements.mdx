...
- [The Ledger Exchange SDK](../howto/ledger-exchange-sdk): details on how to use the swap method of the Ledger Exchange SDK to interact with Ledger Live.
