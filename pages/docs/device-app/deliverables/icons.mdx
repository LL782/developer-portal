...
<Callout type="warning" emoji="⚠️">
  Submitting icons that are not compliant will slow down the process of publishing your embedded App.
</Callout>
...
[![Manager icon template (click to access Illustrator file)](/manager-icon-template.png)](https://drive.google.com/a/ledger.fr/file/d/1OOAZWlnLlBSpScPnF5NGJ4AfczB3D591/view?usp=sharing)
*Manager icon template (click to access Illustrator file)*

## Device icon

<Callout>
	You can use [Photopea](https://www.photopea.com/) to create your icons.
</Callout>
...
[![Ledger Nano S and X icon template (click to access Illustrator file)](/nano-icon-template.png)](https://drive.google.com/a/ledger.fr/file/d/1FVUWDGYPvLuyiwDFgGYiwfwk7YGsxzJ0/view?usp=sharing)
*Ledger Nano S and X icon template (click to access Illustrator file)*


### Stax template

![Ledger Stax icon template](/stax-icons-template.png)
*Ledger Stax icon template (click right and save the file)*
