---
title: Interface
description: It can be challenging to build a user-friendly interface, because of the few inputs and the screen size. The following guidelines will give a good basis to ensure user-friendliness.
---
...
<Callout type="info" emoji="👉">
  See the [BAGL Toolkit](./low-level-display-management/) for more information on the BOLOS Application Graphics Library technical details.
</Callout>
